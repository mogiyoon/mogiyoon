    ...
    <header className="h-20 flex items-center p-4 bg-slate-100">
      <div className="max-w-6xl w-full mx-auto flex justify-between items-center">
        ...
        <nav className="flex items-center gap-4 sm:gap-6 md:gap-10">
          {tabs.map(tab => (
            <Link
              ...
              className={`flex justify-center items-center w-8 h-8 md:w-28 md:h-auto md:py-2 text-base font-medium transition-colors duration-200 rounded-xl ${
                activeTab === tab.id
        ...
        <div className="flex items-center gap-4">
          <button onClick={setModalOpen} className="text-slate-700 hover:text-white hover:bg-slate-900 px-1 py-2 rounded-lg transition-colors duration-300 flex items-center">
            Info
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="text-slate-700 px-1 py-2 rounded-lg transition-colors duration-300 flex items-center hover:bg-slate-100"
            >
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-32 bg-white rounded-xl shadow-lg py-1 z-50 ring-1 ring-black ring-opacity-5">
                <button
