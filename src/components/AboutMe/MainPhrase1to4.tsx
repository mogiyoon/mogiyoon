      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        <div className='absolute inset-0 bg-gradient-to-br from-blue-200 to-purple-200 text-content'>
          ...
          <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-xl sm:text-2xl lg:text-3xl tracking-widest whitespace-nowrap">
              <span className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight">{t('mainPhrase1')}</span><span className="font-thin">{t('mainPhrase2')}</span>{' '}
              <span className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight">{t('mainPhrase3')}</span><span className="font-thin">{t('mainPhrase4')}</span>
          </p>
