    ...
    <section ref={targetRef} className="relative">
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        <div className='absolute inset-0 bg-gradient-to-b from-slate-800 from-20% via-blue-900 via-80% to-orange-700 text-white overflow-hidden'>
          ...
          {/* 텍스트 */}
          <motion.div>
            <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[100%] font-black text-3xl sm:text-4xl lg:text-5xl mt-4 tracking-tight whitespace-nowrap"> {t('developerIntro')} </p>
          </motion.div>
        </div>
      </div>
    </section>
