...
- **Gray 100** (`gray-100` / `#f3f4f6`): 헤더, 내비게이션 배경
- **Gray 200** (`gray-200` / `#e5e7eb`): hover 배경, 구분선 대체

### Text & Content
- **Slate 900** (`slate-900` / `#0f172a`): 최고 강조 — 제목, 탭 텍스트, 주요 콘텐츠
- **Slate 700** (`slate-700` / `#334155`): 준강조 — 서브 헤딩, 라벨
- **Gray 800** (`gray-800` / `#1f2937`): 본문 텍스트 대안
- **Gray 700** (`gray-700` / `#374151`): 보조 텍스트
- **Slate 500** (`slate-500` / `#64748b`): 비활성 텍스트, 아이콘
- **Gray 600** (`gray-600` / `#4b5563`): 메타 정보, 설명
- **Slate 400** (`slate-400` / `#94a3b8`): 3차 텍스트 — placeholder, 타임스탬프
- **Gray 400** (`gray-400` / `#9ca3af`): 가장 약한 텍스트
...
- **Gray 200** (`gray-200` / `#e5e7eb`): 대안 테두리
